...
bool config::LoadConfig(std::string filename) {
    ...
    MODDIR = reader.Get("serialization","moddir","");
    SAVENAME = reader.Get("serialization","savename","");
    LOADNAME = reader.Get("serialization","loadname","");
...
void config::PrintConfig() {
    ...
    std::cout << "\n***SERIALIZATION***\n"
            ...
            << "MODDIR:   " << MODDIR << std::endl
            << "SAVENAME: " << SAVENAME << std::endl
            << "LOADNAME: " << LOADNAME << std::endl
            << std::endl;
